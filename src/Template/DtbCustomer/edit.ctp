...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $dtbCustomer->customer_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $dtbCustomer->customer_id)]
            )
        ?></li>
...
<div class="dtbCustomer form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Dtb Customer') ?></legend>
        <?php
            ...
            echo $this->Form->control('email_mobile');
            ...
            echo $this->Form->control('first_buy_date', ['empty' => true]);
            echo $this->Form->control('last_buy_date', ['empty' => true]);
            echo $this->Form->control('buy_times');
            echo $this->Form->control('buy_total');
            ...
            echo $this->Form->control('mobile_phone_id');
            echo $this->Form->control('mailmaga_flg');
