...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $dtbProductStatus->product_status_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $dtbProductStatus->product_status_id)]
            )
        ?></li>
...
<div class="dtbProductStatus form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Dtb Product Status') ?></legend>
        <?php
